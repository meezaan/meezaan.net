...
var TinyMCE_SimpleTheme = {
	...
	execCommand : function(editor_id, element, command, user_interface, value) {
		switch (command) {
			case "popUpEditor":
				...
				template['file'] = '../../htmleditor.php?themceinstance='+editor_id;
				...
				// vrthismceinst=tinyMCE.getInstanceById(editor_id)
				// document.getElementById('theforminstance').value=vrthismceinst.formTargetElementId;
				return true;
		}
	...
	getEditorTemplate : function() {
		...
		html += '<img src="{$themeurl}/images/separator.gif" width="2" height="20" class="mceSeparatorLine">';
		html += tinyMCE.getButtonHTML('code', 'lang_plus_desc', '{$themeurl}/images/plus.gif', 'popUpEditor')
