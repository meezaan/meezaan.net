...
<center><span class="heading">Shipping Policy</span></center>
<p>
All items in this store are intangible and are currently NOT available for shipping.  All items are available for download upon purchase, and are subject to the terms & conditions specified with each product.</p>
<p>
<center><span class="heading">Returns & Refunds</span></center></p>
<p>
All items on this shopping store are NON-returnable and NON-refundable.  If an item download fails, please contact us on store[at]asifnawaz.net with the problem.  <br /><br />Kindly note that ALL domain names are subject to our <a href="docs/domain_lease.pdf">domain name leasing policy</a>.
</p>


After your domain lease purchase, you will receive an email within 24 hours, to which you MUST reply with the DNS Servers you would like the domain pointed to.
		</td>
	</tr>
	<tr>
